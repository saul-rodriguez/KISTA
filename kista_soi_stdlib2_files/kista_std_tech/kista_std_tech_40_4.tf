...
viaDefs(
 ...
 ;( ----------       -------     -------- -------- ------ ------ ----------------)
    ( M2_M1_HV         KISTA_SOI_STDLIB2 M2_M1_HV       via Metal1 Metal2     0.0)
    ( M2_M1_VV         KISTA_SOI_STDLIB2 M2_M1_VV       via Metal1 Metal2     0.0)
    ( M2_M1_VH         KISTA_SOI_STDLIB2 M2_M1_VH       via Metal1 Metal2     0.0)
    ( M2_M1_HH         KISTA_SOI_STDLIB2 M2_M1_HH       via Metal1 Metal2     0.0)
 ...
 ;  ( M2_M1_1x2_HV_S  gsclib045_tech M2_M1_1x2_HV_S via Metal1 Metal2 0.0)
    ( M3_M2_VH        KISTA_SOI_STDLIB2 M3_M2_VH       via Metal2 Metal3 0.0)
    ( M3_M2_HH        KISTA_SOI_STDLIB2 M3_M2_HH       via Metal2 Metal3 0.0)
    ( M3_M2_HV        KISTA_SOI_STDLIB2 M3_M2_HV       via Metal2 Metal3 0.0)
    ( M3_M2_VV        KISTA_SOI_STDLIB2 M3_M2_VV       via Metal2 Metal3 0.0)
 ...
 ;   ( M4_M3_HV        KISTA_SOI_STDLIB2 M4_M3_HV       via Metal3 Metal4 0.0)
 ;   ( M4_M3_VV        KISTA_SOI_STDLIB2 M4_M3_VV       via Metal3 Metal4 0.0)
 ;   ( M4_M3_VH        KISTA_SOI_STDLIB2 M4_M3_VH       via Metal3 Metal4 0.0)
 ;   ( M4_M3_HH        KISTA_SOI_STDLIB2 M4_M3_HH       via Metal3 Metal4 0.0)
