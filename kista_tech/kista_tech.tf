...
layerDefinitions(
  techLayers(
    ...
    ;( ---------                   ------      ------------  )
     ...
     ;( M4Resdum                  102        M4Resdum     )
      ( KTH_source                120        KTHsource    )
      ( KTH_sblock                121        KTH_sblock   )
      ( KTH_openpad               122        KTH_openpad  )
      ( KTH_align                 123        KTH_align    )
      ( KTH_mim1                  124        KTH_mim1     )
      ( KTH_mim2                  125        KTH_mim2     )
      ( KTH_mim3                  126        KTH_mim3     )
      ( KTH_L1                    127        KTH_L1       )
      ( KTH_L2                    128        KTH_L2       )
      ( KTH_L3                    129        KTH_L3       )
      ( KTH_L4                    130        KTH_L4       )
      ( KTH_L5                    131        KTH_L5       )
	  ( KTH_nodrc                 132        KTH_nodrc    )
 ...
 ( noOverlapLayer1           10001           ( CapMetal   'and    Metal1    ))
  ...
  ( KTH_source   drawing      KTH_sourcedr     t t t t t )
  ( KTH_sblock   drawing      KTH_sblock       t t t t t )
  ( KTH_openpad  drawing      KTH_openpad      t t t t t )
  ( KTH_align    drawing      KTH_align        t t t t t )
  ( KTH_mim1     drawing      KTH_mim1         t t t t t )
  ( KTH_mim2     drawing      KTH_mim2         t t t t t )
  ( KTH_mim3     drawing      KTH_mim3         t t t t t )
  ( KTH_L1       drawing      KTH_L1           t t t t t )
  ( KTH_L2       drawing      KTH_L2           t t t t t )
  ( KTH_L3       drawing      KTH_L3           t t t t t )
  ( KTH_L4       drawing      KTH_L4           t t t t t )
  ( KTH_L5       drawing      KTH_L5           t t t t t )
  ( KTH_nodrc    drawing      KTH_nodrc        t t t t t )
  ...
  ( resistancePerCut       Via1 			  0.1 )
  ( resistancePerCut       Via2 			  0.1 )
  ;( resistancePerCut       Via3 			  0.1 )
...
layerRules(
 ...
 ; ( avgDCCurrentDensity 	"Metal4"		2.0	 )
  ...
  stampLabelLayers(
    ...
    ;( (---------  -------   ) ---------------------------------------- )
     ( text      	Poly      	Metal1    	Metal2    	Metal3    	)
  ) ;stampLabelLayers
...
constraintGroups(
 ...
 ;( -----	---------- )
  ( "virtuosoDefaultExtractorSetup"	nil
    ...
    interconnect(
     ( validLayers   (substrate2 gate polycutoxide resdumcutpoly resdumcutoxide  resWdumcutoxide resdumcutnwell capmetalcutmetal PWdummy Nwell  Oxide  Poly Nimp Pimp  Cont  d_Met1_noRes  Via1  d_Met2_noRes  Via2  d_Met3_noRes  ) )
    ) ;interconnect
 ...
 ;( -----	---------- )
  ( "virtuosoDefaultSetup"	nil
    ...
    interconnect(
     ( validLayers   (Poly Metal1 Metal2  Metal3  ) )
     ( validVias     (M1_PO  M1_NWELL  M1_PSUB  M1_NIMP  M1_PIMP  M1_DIFF  M2_M1  M3_M2  ) )
    ) ;interconnect
...
;		( minSpacing		"Via3" 1.0 )
  ...
  spacings(
     ( stackable                  "Via1"	"Via2"		nil )
    ; ( stackable                  "Via2"	"Via3"		nil )
    ; ( stackable                  "Via3"	"Via4"		nil )
